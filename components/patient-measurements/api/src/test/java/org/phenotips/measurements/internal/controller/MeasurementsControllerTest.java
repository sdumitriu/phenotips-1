...
public class MeasurementsControllerTest {
	...
	@Rule
	public MockitoComponentMockingRule<PatientDataController<MeasurementEntry>> mocker = new MockitoComponentMockingRule
			<PatientDataController<MeasurementEntry>>(MeasurementsController.class);
	...
	public void gettingHandlerThrowsException() throws ComponentLookupException {
		List<MeasurementEntry> internalList = new LinkedList<>();
		String age = "67";
		Date date = new Date(1999 - 03 - 03);
		String type = "foot";
