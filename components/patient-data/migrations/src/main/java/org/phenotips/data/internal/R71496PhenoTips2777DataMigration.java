...
import org.phenotips.vocabulary.internal.DefaultVocabularyManager;
 ...
 */
@Component
@Named("R71496-PT-2777")
@Singleton
public class R71496PhenoTips2777DataMigration extends AbstractHibernateDataMigration implements
    HibernateCallback<Object>
{
    ...
    private String getEnsemblId(final String geneSymbol) {
        final VocabularyTerm term = ((DefaultVocabularyManager) this.vocabularies).resolveTerm("HGNC", geneSymbol);
        @SuppressWarnings("unchecked")
